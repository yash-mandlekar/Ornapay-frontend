...
const ProductItem = ({ item }: { item: Product }) => {
  ...
  return (
    <div className="group">
      ...
      <div className="relative overflow-hidden flex items-center justify-center rounded-lg bg-[#f5f1ed] min-h-[270px] mb-4">
        <Image
          src={getProductImage()}
          alt={item.title}
          width={250}
        ...
        <div className="absolute left-0 bottom-0 translate-y-full w-full flex items-center justify-center gap-2.5 pb-5 ease-linear duration-200 group-hover:translate-y-0">
          ...
          <button
            ...
            className="flex items-center justify-center w-9 h-9 rounded-[5px] shadow-lg ease-out duration-200 bg-white transition-all hover:shadow-xl"
            style={{ color: "#832729" }}
          >
            <svg
          ...
          <button
            ...
            className="inline-flex font-semibold text-sm py-2 px-5 rounded-[5px] text-white ease-out duration-200 transition-all hover:shadow-lg disabled:opacity-50 disabled:cursor-not-allowed"
            style={{
      ...
      {/* Product Title */}
      <h3 className="font-semibold text-base mb-1.5 transition-colors duration-200 hover:opacity-70">
        <Link 
          href={`/shop/${item._id}`}
      ...
      {!isOutOfStock && (
        <div className="flex items-center gap-2 font-medium text-lg">
          <span style={{ color: "#4F1719" }}>₹{item.discountPrice}</span>
