        ...
        <div className="w-full max-w-[1100px] rounded-xl shadow-3 bg-white p-7.5 relative modal-content">
          ...
          <div className="flex flex-wrap items-center gap-12.5">
            ...
            <div className="max-w-[445px] w-full">
              ...
              {isOutOfStock && (
                <span className="inline-block text-custom-xs font-medium text-white py-1 px-3 bg-red-500 mb-6.5">
                  OUT OF STOCK
                </span>
              )}
              ...
              <div className="flex flex-wrap items-center gap-5 mb-6">
                <div className="flex items-center gap-1.5">
                  {/* stars removed as per requirements */}
                </div>
                  ...
                  {isOutOfStock ? (
                    <>
                      ...
                      >
                        ...
                        <line x1="6" y1="10" x2="14" y2="10" stroke="#EF4444" strokeWidth="2"/>
                      </svg>
                    ...
                    <>
                      ...
                      <span className="font-medium text-dark"> In Stock ({product.stock}) </span>
                    </>
                  )}
                </div>
              </div>

              <p dangerouslySetInnerHTML={{ __html: product.excerpt || product.description || "" }} />
