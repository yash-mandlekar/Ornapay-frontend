  ...
  return (
    ...
    >
      <div className="max-w-[1170px] w-full mx-auto px-4 sm:px-8 xl:px-0">
        <div
          className="relative overflow-hidden rounded-2xl bg-white border-2 shadow-2xl"
          style={{ borderColor: "#832729" }}
        >
          <div className="flex flex-col lg:flex-row items-center lg:items-stretch">
            ...
            <div className="w-full lg:w-1/2 p-6 sm:p-8 lg:p-10 xl:p-16 relative z-10">
              <span
                ...
                style={{ backgroundColor: "#f5f1ed", color: "#832729" }}
              >
                Exclusive Offer
              </span>

              <h2
                className="font-bold text-3xl lg:text-4xl xl:text-5xl mb-4"
                style={{ color: "#4F1719" }}
              >
              ...
              <div className="flex flex-wrap gap-4 sm:gap-6 mb-8">
                ...
                <div className="flex flex-col items-center">
                  ...
                  <span
                    className="block text-xs sm:text-sm font-semibold text-center"
                    style={{ color: "#4F1719" }}
                  >
                    Days
                  </span>
