        ...
        <div className="swiper categories-carousel common-carousel">
          ...
          <div className="mb-10 flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              <button 
                onClick={handlePrev} 
                className="swiper-button-prev w-10 h-10 rounded-full border border-gray-300 hover:border-blue-600 hover:bg-blue-50 flex items-center justify-center transition-all"
              ...
              <button 
                onClick={handleNext} 
                className="swiper-button-next w-10 h-10 rounded-full border border-gray-300 hover:border-blue-600 hover:bg-blue-50 flex items-center justify-center transition-all"
